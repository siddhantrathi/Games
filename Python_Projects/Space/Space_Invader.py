...
wb = xl.load_workbook('HighScore.xlsx')
sheet = wb['Sheet1']
...
score_value = 0
font = pygame.font.Font('PixelFJVerdana12pt.ttf', 16)
...
high_score_value = sheet.cell(row=1, column=1).value
high_score_textX = 550
high_score_textY = 10
...
while running:
    ...
    if score_value > sheet.cell(row=1, column=1).value:
        ...
        wb.save('HighScore.xlsx')
        score_value = sheet.cell(row=1, column=1).value
    ...
    show_HighScore(high_score_textX, high_score_textY)
